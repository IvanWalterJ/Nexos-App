      ...
      >
        ...
        <div className="glass rounded-3xl p-8 sm:p-10 space-y-8">
          <div className="space-y-2">
            <h1 className="text-3xl font-black tracking-tight text-gradient">Bienvenido de nuevo</h1>
            <p className="text-n-500 text-sm font-medium">Ingresá tus credenciales para continuar</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between">
                ...
                <Link href="/auth/forgot-password" className="text-xs font-bold text-primary-lit hover:underline">
                  ¿La olvidaste?
                </Link>
              </div>
              <div className="relative group">
          ...
          <p className="text-center text-xs text-n-600">
            ¿No tenés cuenta?{" "}
            <Link href="/" className="text-primary-lit font-bold hover:underline">Regístrate</Link>
          </p>
        </div>
      </motion.div>
    </main>
